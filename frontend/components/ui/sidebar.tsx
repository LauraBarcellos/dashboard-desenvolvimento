...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-1 overflow-auto group-data-[collapsible=icon]:overflow-hidden px-2 py-3",
        className
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  // Fixed width for skeleton (70% - average between 50-90%)
  const width = '70%'
